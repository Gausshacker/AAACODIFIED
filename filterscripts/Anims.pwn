//-------------------------------------------------------------------------------------
//
// MikeyAnims IV (Uso exclusivo LSRP.es) :trollface:
// Basado en Seifanimations.
//
//-------------------------------------------------------------------------------------
...
//------------------------------------------------
Anims_OnPlayerDeath(playerid, killerid, reason)
{
...
Anims_OnPlayerCommandText(playerid, cmdtext[])
{
	...
	if(strcmp(cmd,"/animaciones",true)==0)
	{
        ...
        SendClientMessage(playerid,WHITE,"/saludo - /trato - /crack - /fumando - /sentarse - /gro - /fucku - /hablando - /taichi - /caer - /muerto - /brazos - /gangsta");
    ...
    {
        if (!strlen(cmdtext[7])) return SendClientMessage(playerid,0xEFEFF7AA,"Uso: /crack [1-8]");
    	switch (cmdtext[7])
    	{
    ...
    {
        if (!strlen(cmdtext[9])) return SendClientMessage(playerid,0xEFEFF7AA,"Uso: /fumando [1-5]");
    	switch (cmdtext[9])
    	{
    ...
    {
        if (!strlen(cmdtext[10])) return SendClientMessage(playerid,0xEFEFF7AA,"Uso: /sentarse [1-9]");
    	switch (cmdtext[10])
    	{
    ...
    {
        if (!strlen(cmdtext[8])) return SendClientMessage(playerid,0xEFEFF7AA,"Uso: /saludo [1-7]");
    	switch (cmdtext[8])
    	{
			...
			default: SendClientMessage(playerid,0xEFEFF7AA,"Uso: /saludo [1-7]");
    	}
    	return 1;
    }
...
// Chupete
    ...
    {
        if (!strlen(cmdtext[8])) return SendClientMessage(playerid,0xEFEFF7AA,"Uso: /basket [1-7]");
    	switch (cmdtext[8])
    	{
...
// Trafico
    ...
    {
        if (!strlen(cmdtext[9])) return SendClientMessage(playerid,0xEFEFF7AA,"Uso: /apuntar [1-3]");
    	switch (cmdtext[9])
    	{
    ...
    {
        if (!strlen(cmdtext[10])) return SendClientMessage(playerid,0xEFEFF7AA,"Uso: /apoyarse [1-2]");
    	switch (cmdtext[10])
    	{
    ...
    {
        if (!strlen(cmdtext[6])) return SendClientMessage(playerid,0xEFEFF7AA,"Uso: /beso [1-2]");
    	switch (cmdtext[6])
    	{
    ...
    {
        if (!strlen(cmdtext[8])) return SendClientMessage(playerid,0xEFEFF7AA,"Uso: /billar [1-3]");
    	switch (cmdtext[8])
    	{
    ...
    {
        if (!strlen(cmdtext[7])) return SendClientMessage(playerid,0xEFEFF7AA,"Uso: /strip [1-7]");
    	switch (cmdtext[7])
    	{
