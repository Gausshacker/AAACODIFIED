//Ayuda admin.
 ...
 if(strcmp(cmd, "/adminhelp", true) == 0 || strcmp(cmd, "/ah", true) == 0 || strcmp(cmd, "/ahelp", true) == 0)
 {
     ...
     {
   new pagina;
   if(PlayerInfo[playerid][pAdmin] == 4) pagina = 7;
   ...
   switch(pagina)
   {
    ...
    case 2:
    {
     ...
     SendClientMessage(playerid, Blanco, "{00BE00}[_MOD_1_] {FFFFFF}/hchatadmin - /daruniforme - /adminservicio - /slap - /ajail - /kick - /ban - /banip - /reeducar - /advertir - /mark - /gotomark - /ir - /vermaletero");
     SendClientMessage(playerid, Blanco, "{00BE00}[_MOD_1_] {FFFFFF}/(borrar)dudas - /rduda - /borrarduda - /(borrar)reportes - /verreporte - /borrarreporte - /goto - /teleplayer - /hide - /editgz");
     SendClientMessage(playerid, Blanco, "{00BE00}[_MOD_1_] {FFFFFF}/setint - /setvw - /mover - /spec - /verarmas - /con(gelar) - /carinfo - /privados - /pms - /versms - /ao - /check - /verinventario");
     SendClientMessage(playerid, Blanco, "{00BE00}[_MOD_1_] {FFFFFF}/afindcar - /afixpos - /resitecar - /findadmincar - /findteamcar - /adminbloqueo - /healcar - /oldcar - /verllaves - /premiums");
    }
    case 3:
    {
     SendClientMessage(playerid, Verde, "|________________________________________________________________________________________________________________________________________________________________________________|");
